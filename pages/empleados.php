    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item" id="empleados"><a class="nav-link active" href="empleados.php"><i class="fas fa-user"></i><span>Empleados</span></a></li>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle invisible nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="badge bg-danger badge-counter">2+</span><i class="fas fa-bell fa-fw"></i></a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                    ...
                                    </a><a class="dropdown-item text-center small text-gray-500" href="#">Mostrar todo</a>
                                </div>
                            </div>
                        </li>
            ...
            <div class="container-fluid">
                <h2 class="text-dark mb-0 fw-bold">Listado de Empleados</h2>
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top mt-4">
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav align-items-center flex-nowrap ms-auto">
                            ...
                            <li class="nav-item ms-1"><button class="btn btn-primary" type="button" style="border-bottom-style: none;" data-bs-target="#modal-agregar-empleado" data-bs-toggle="modal">Nuevo</button></li>
                        </ul>
                    </div>
                </nav>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title fw-bold">Agregar nuevo empleado</h5><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
                                <div class="mb-3"><label class="form-label form-label" for="proveedor_nombre">Nombre</label><input type="text" id="nombre-empleado" class="form-control" name="nombre-empleado"></div>
                                <div class="mb-3"><label class="form-label form-label" for="edad-empleado">Edad</label><input type="text" id="edad-empleado" class="form-control" name="edad-empleado"></div>
                                <div class="mb-3"><label class="form-label form-label" for="email-empleado">Email</label><input type="text" id="email-empleado" class="form-control" name="email-empleado"></div>
                                <div class="mb-3"><label class="form-label form-label" for="empleado-telefono">Teléfono</label><input type="text" id="empleado-telefono" class="form-control" name="empleado-telefono"></div>
                            </div>
                ...
                <div class="modal fade" role="dialog" tabindex="-1" id="modal-eliminar-empleado">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <table class="table table-hover my-0" id="dataTable">
                                ...
                                <tr>
                                    <td class="fw-semibold d-flex">
                                        ...
                                        <div id="estado"><a class="d-block order-first text-decoration-none" href="empleado-detaller.php">Empleado 1</a><i class="fas fa-circle text-success me-1"></i><span class="order-last">Online</span></div>
                                    </td>
                                    <td>1</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
                                    <td>999 999 999</td>
                                    <td><a id="eliminar" class="ms-3" href="#" data-bs-target="#modal-eliminar-empleado" data-bs-toggle="modal"><i class="fas fa-trash-alt text-danger text-bg-light"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="d-flex">
                                        ...
                                        <div id="estado-1"><a class="d-block order-first text-decoration-none" href="#">Empleado 2</a><i class="fas fa-circle text-danger me-1"></i><span class="order-last">Offline</span></div>
                                    </td>
                                    <td>2</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
                                    <td>999 999 999</td>
                                    <td><a id="eliminar-1" class="ms-3" href="#" data-bs-target="#modal-eliminar-empleado" data-bs-toggle="modal"><i class="fas fa-trash-alt text-danger text-bg-light"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="d-flex">
                                        ...
                                        <div id="estado-2"><a class="d-block order-first text-decoration-none" href="#">Empleado 3</a><i class="fas fa-circle text-success me-1"></i><span class="order-last">Online</span></div>
                                    </td>
                                    <td>3</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
                                    <td>999 999 999</td>
                                    <td><a id="eliminar-2" class="ms-3" href="#" data-bs-target="#modal-eliminar-empleado" data-bs-toggle="modal"><i class="fas fa-trash-alt text-danger text-bg-light"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="d-flex">
                                        ...
                                        <div id="estado-3"><a class="d-block order-first text-decoration-none" href="#">Empleado 4</a><i class="fas fa-circle text-success me-1"></i><span class="order-last">Online</span></div>
                                    </td>
                                    <td>4</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        ...
                                        <div id="estado-4"><a class="d-block order-first text-decoration-none" href="#">Empleado 5</a><i class="fas fa-circle text-danger me-1"></i><span class="order-last">Offline</span></div>
                                    </td>
                                    <td>5</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        ...
                                        <div id="estado-5"><a class="d-block order-first text-decoration-none" href="#">Empleado 6</a><i class="fas fa-circle text-success me-1"></i><span class="order-last">Online</span></div>
                                    </td>
                                    <td>6</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        ...
                                        <div id="estado-6"><a class="d-block order-first text-decoration-none" href="#">Empleado 7</a><i class="fas fa-circle text-success me-1"></i><span class="order-last">Online</span></div>
                                    </td>
                                    <td>7</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        ...
                                        <div id="estado-7"><a class="d-block order-first text-decoration-none" href="#">Empleado 8</a><i class="fas fa-circle text-success me-1"></i><span class="order-last">Online</span></div>
                                    </td>
                                    <td>8</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        ...
                                        <div id="estado-8"><a class="d-block order-first text-decoration-none" href="#">Empleado 9</a><i class="fas fa-circle text-success me-1"></i><span class="order-last">Online</span></div>
                                    </td>
                                    <td>9</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        ...
                                        <div id="estado-9"><a class="d-block order-first text-decoration-none" href="#">Empleado 10</a><i class="fas fa-circle text-success me-1"></i><span class="order-last">Online</span></div>
                                    </td>
                                    <td>10</td>
                                    <td>25</td>
                                    <td>usuario@gmail.com</td>
