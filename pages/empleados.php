    ...
    <div class="container-fluid d-flex flex-column p-0">
        ...
        <ul class="navbar-nav text-light" id="accordionSidebar">
            ...
            <li class="nav-item" id="perfil">
                <a class="nav-link" href="perfil.php"><i class="fas fa-user"></i><span>Mi Perfil</span>
                </a>
            </li>
            <li class="nav-item" id="inventario">
                <div>
                    <a class="btn btn-link nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapse-2" href="#collapse-2" role="button"><i class="fas fa-th-large"></i>&nbsp;<span>Inventario</span></a>
                    <div class="collapse" id="collapse-2">
                        <div class="bg-white border rounded py-2 collapse-inner">
                            <a class="collapse-item" href="productos.php">Productos</a>
                            <a class="collapse-item" href="categorias.php">Categorías</a></div>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item" id="reportes">
                <a class="nav-link" href="ventas.php"><i class="fas fa-tasks"></i><span>Reporte de ventas</span></a>
            </li>
            <li class="nav-item" id="calendario">
                <a class="nav-link" href="calendario.php"><i class="far fa-calendar"></i><span>Calendario</span></a>
            </li>
            <li class="nav-item" id="docs">

            </li>
            <li class="nav-item" id="empleados">
                <a class="nav-link active" href="empleados.php"><i class="fas fa-user"></i><span>Empleados</span></a>
            </li>
            <li class="nav-item" id="clientes">
                <a class="nav-link" href="clientes.php"><i class="fas fa-user"></i><span>&nbsp;Clientes</span></a>
            </li>
            <li class="nav-item" id="proveedores">
                <a class="nav-link" href="proveedores.php"><i class="fas fa-truck"></i><span>&nbsp;Proveedores</span></a>
            </li>
        </ul>
            ...
            <ul class="navbar-nav align-items-center flex-nowrap ms-auto">
                ...
                <li class="nav-item ms-1">
                    <button class="btn btn-primary" type="button" style="border-bottom-style: none;"
                            data-bs-target="#modal-agregar-empleado" data-bs-toggle="modal">Nuevo
                    </button>
                </li>
            </ul>
        </div>
                ...
                <table class="table table-hover my-0" id="dataTable">
                    ...
                    <tr>
                        <td class="fw-semibold d-flex">
                            ...
                            <div id="estado">
                                <a class="d-block order-first text-decoration-none" href="empleado-detaller.php">Empleado 1</a>
                                <i class="fas fa-circle text-success me-1"></i><span class="order-last">Online</span>
                            </div>
                        </td>
                        <td>1</td>
                        <td>25</td>
                        ...
                        <td>999 999 999</td>
                        <td>
                            <a id="eliminar" class="ms-3" href="#" data-bs-target="#modal-eliminar-empleado"
                               data-bs-toggle="modal"><i class="fas fa-trash-alt text-danger text-bg-light"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td class="d-flex">
                            ...
                            <div id="estado-1">
                                <a class="d-block order-first text-decoration-none" href="#">Empleado 2</a>
                                <i class="fas fa-circle text-danger me-1"></i><span class="order-last">Offline</span>
                            </div>
                        </td>
                        <td>2</td>
                        <td>25</td>
                        <td>usuario@gmail.com</td>
                        <td>999 999 999</td>
                        <td><a id="eliminar-1" class="ms-3" href="#" data-bs-target="#modal-eliminar-empleado"
                               data-bs-toggle="modal"><i class="fas fa-trash-alt text-danger text-bg-light"></i></a>
                        </td>
                    </tr>
                    </tbody>
