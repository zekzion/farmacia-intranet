...
<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark bg-gradient-primary p-0">
    <div class="container-fluid d-flex flex-column p-0"><a
        ...
        <ul class="navbar-nav text-light" id="accordionSidebar">
            ...
            <li class="nav-item" id="perfil"><a class="nav-link" href="perfil.php"><i class="fas fa-user"></i><span>Mi Perfil</span></a>
            </li>
            ...
            <li class="nav-item" id="proveedores"><a class="nav-link active" href="proveedores.php"><i
    ...
    <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav align-items-center flex-nowrap ms-auto">
                <li class="nav-item dropdown d-sm-none align-items-center m-auto no-arrow"><a
                            class="dropdown-toggle nav-link align-items-center m-auto" aria-expanded="false"
                ...
                <li class="nav-item">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu"><a onclick="descargarPDF('dataTable')" class="dropdown-item"
                                                      href="#">PDF</a></div>
                    </div>
                </li>
                <li class="nav-item ms-1">
                    <button class="btn btn-primary" type="button" style="border-bottom-style: none;"
                            data-bs-target="#modal-agregar-proveedor" data-bs-toggle="modal">Nuevo
                    </button>
                </li>
            </ul>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold">Agregar nuevo proveedor</h5>
                    <button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3"><label class="form-label form-label" for="proveedor_nombre">Nombre</label><input
                                type="text" class="form-control" name="proveedor_nombre"></div>
                    <div class="mb-3"><label class="form-label form-label" for="proveedor_email">Email</label><input
                                type="text" class="form-control" name="proveedor_email"></div>
                    <div class="mb-3"><label class="form-label form-label"
                                             for="proveedor_contacto">Contacto</label><input type="text"
                                                                                             class="form-control"
                                                                                             name="proveedor_contacto">
                    </div>
                    <div class="mb-3"><label class="form-label form-label"
                                             for="proveedor_telefono">Teléfono</label><input type="text"
                                                                                             class="form-control"
            ...
            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                <table class="table my-0" id="dataTable">
                    ...
                    <tr>
                        ...
                        <td class="text-start">
                            <a id="editar" href="#">
                                <i class="fas fa-pencil-alt text-primary text-bg-light"></i>
                            </a>
                            <a id="eliminar" class="ms-3" href="#" data-bs-target="#modal-eliminar-proveedor" data-bs-toggle="modal">
                                <i class="fas fa-trash-alt text-danger text-bg-light"></i>
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>Contacto 2</td>
                        <td>999 999 999</td>
                        <td><a id="editar-1" href="#"><i class="fas fa-pencil-alt text-primary text-bg-light"></i></a><a
                                    id="eliminar-1" class="ms-3" href="#" data-bs-target="#modal-eliminar-proveedor"
                                    data-bs-toggle="modal"><i
                                        class="fas fa-trash-alt text-danger text-bg-light"></i></a></td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Proveedor 3</td>
                        ...
                        <td>Contacto 3</td>
                        <td>999 999 999</td>
                        <td><a id="editar-2" href="#"><i class="fas fa-pencil-alt text-primary text-bg-light"></i></a><a
                                    id="eliminar-2" class="ms-3" href="#" data-bs-target="#modal-eliminar-proveedor"
                                    data-bs-toggle="modal"><i
                                        class="fas fa-trash-alt text-danger text-bg-light"></i></a></td>
                    </tr>
                    <tr>
                        ...
                        <td>Contacto 4</td>
                        <td>999 999 999</td>
                        <td><a id="editar-3" href="#"><i class="fas fa-pencil-alt text-primary text-bg-light"></i></a><a
                                    id="eliminar-3" class="ms-3" href="#"><i
                                        class="fas fa-trash-alt text-danger text-bg-light"></i></a></td>
                    </tr>
                    <tr>
                        <td>5</td>
                        ...
                        <td>999 999 999</td>
                        <td>
                            <a id="editar-4" href="#"><i class="fas fa-pencil-alt text-primary text-bg-light"></i></a>
                            <a id="eliminar-4" class="ms-3" href="#">
                                <i class ="fas fa-trash-alt text-danger text-bg-light"></i>
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>999 999 999</td>
                        <td>
                            <a id="editar-5" href="#"><i class="fas fa-pencil-alt text-primary text-bg-light"></i></a>
                            <a id="eliminar-5" class="ms-3" href="#">
                                <i class="fas fa-trash-alt text-danger text-bg-light"></i>
                            </a>
                        </td>
                    </tr>
