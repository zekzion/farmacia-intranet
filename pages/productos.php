...
<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
    <div class="container-fluid d-flex flex-column p-0"><a
        ...
        <ul class="navbar-nav text-light" id="accordionSidebar">
            <li class="nav-item" id="dashboard"><a class="nav-link" href="../public/index.php"><i
            ...
            <li class="nav-item" id="inventario">
                <div><a class="btn btn-link nav-link" data-bs-toggle="collapse" aria-expanded="false"
                    ...
                    <div class="collapse" id="collapse-2">
                        <div class="bg-white border rounded py-2 collapse-inner"><a class="fw-bold collapse-item"
            ...
            <li class="nav-item" id="notificaciones"><a class="nav-link" href="notificaciones.php"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-secondary">Registrar Nuevo Producto</h4>
                    ...
                    <div class="row" id="nom">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="nombre-producto"
                                       placeholder="Nombre del Producto" name="nombre-producto">
                            </div>
                        </div>
                    </div>
                    <div class="row" id="nom">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="categoria-producto"
                                       placeholder="Categoria del Producto" name="categoria-producto">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="prec-cant">
                        <div class="col">
                            <div class="mb-3"><label class="form-label"
                                                     for="precio-producto"><strong>Precio</strong></label>
                                <input class="form-control" type="text" name="precio-producto" id="precio-producto">
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3"><label class="form-label"
                                                     for="cantidad-producto"><strong>Cantidad</strong></label>
...
<div class="modal fade" role="dialog" tabindex="-1" id="modal-editar-producto">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-secondary">Editar Producto</h4>
                <button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form action="productos.php" method="post">
                    <div class="row" id="nom-1">
                        <div class="col">
                            <div class="mb-3"><label class="form-label"
                                                     for="service_name"><strong>Nombre</strong></label><input
                                        class="form-control" type="text" id="service_name-2" name="nombre-producto"
                                        required=""></div>
                        </div>
                    </div>
                    <div id="descrip-1" class="mb-3"><label class="form-label" for="client_description"><strong>Descripción</strong></label><textarea
                                class="form-control" id="service_description-2" rows="4" name="descripcion-producto"
                                required=""></textarea></div>
                    <div class="row" id="prec-cant-1">
                        <div class="col">
                            <div class="mb-3"><label class="form-label"
                                                     for="service_client_start_date"><strong>Precio</strong></label><input
                                        class="form-control" type="text"></div>
                        </div>
                        <div class="col">
                            <div class="mb-3"><label class="form-label"
                                                     for="service_client_end_date"><strong>Cantidad</strong></label><input
                                        class="form-control" type="text"></div>
                        </div>
                    </div>
                    <div id="img-prod-2" class="mb-3"><label class="form-label"
                                                             for="service_client_payment_validated"><strong>Imagen del
                                Producto</strong></label>
                        <div class="form-group mb-3"><input class="form-control" type="file" name="imagen-producto">
                        </div>
                    </div>
            ...
            <ul class="navbar-nav align-items-center flex-nowrap ms-auto">
                ...
                <li class="nav-item">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu"><a onclick="descargarPDF('dataTables')" class="dropdown-item"
                                                      id="aPDF" href="#">PDF</a></div>
                    </div>
                </li>
                <li class="nav-item ms-1">
                    <button class="btn btn-primary" type="button" style="border-bottom-style: none;"
                            data-bs-target="#modal-agregar-producto" data-bs-toggle="modal">Nuevo
                    </button>
                </li>
            </ul>
        </div>
                    ...
                    if (isset($_SESSION['productos'])) {
                        foreach ($_SESSION['productos'] as $producto) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#" data-id="<?php echo $producto['id']; ?>" data-bs-toggle="modal"
                                       data-bs-target="#modal-eliminar-producto"><i
                                                class="fas fa-trash-alt text-danger text-bg-light"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
